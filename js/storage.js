	...
	load: function (bgUrl, bgid, hues) {
		...
		if (!hues) {
			...
			case 'shaymin':
				...
				break;
			case 'charizards':
				hues = ["37,74%", "10.874999999999998,70.79646017699115%", "179.51612903225808,52.10084033613446%", "20.833333333333336,36.73469387755102%", "192.3076923076923,80.41237113402063%", "210,29.629629629629633%"];
				break;
			case 'psday':

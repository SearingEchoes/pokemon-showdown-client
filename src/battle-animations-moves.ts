...
export const BattleMoveAnims: AnimTable = {
	...
	antidamage: {
		...
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect('#00DD4A', 700, 0.2);
			scene.showEffect('ninjastar', {
				x: attacker.x,
				y: attacker.y - 25,
				z: attacker.z,
...
BattleMoveAnims['mineralpelt'] = {anim: BattleMoveAnims['powergem'].anim};
BattleMoveAnims['laevatein'] = {anim: BattleMoveAnims['bitterblade'].anim};
BattleMoveAnims['sandymash'] = {anim: BattleMoveAnims['sandtomb'].anim};
BattleMoveAnims['boltkick'] = {
	anim(scene, [attacker, defender]) {
...
BattleMoveAnims['subterraneansun'] = {
		anim(scene, [attacker, defender]) {
		scene.backgroundEffect('linear-gradient(#390000 30%, #B84038)', 700, 0.4);
			scene.showEffect('kdriver', {
				x: attacker.x,
...
BattleMoveAnims['spectralray'] = {anim: BattleMoveAnims['moongeistbeam'].anim};
BattleMoveAnims['hisousword'] = {
	anim(scene, [attacker, defender]) {
		BattleMoveAnims['skyuppercut'].anim(scene, [attacker, defender]);
		BattleMoveAnims['slash'].anim(scene, [attacker, defender]);
	},
};
BattleMoveAnims['skitterrush'] = {anim: BattleMoveAnims['firstimpression'].anim};
BattleMoveAnims['mindseye'] = {anim: BattleMoveAnims['quiverdance'].anim};
BattleMoveAnims['manapunch'] = {anim: BattleMoveAnims['shadowpunch'].anim};
BattleMoveAnims['gapzone'] = {anim: BattleMoveAnims['assist'].anim};
BattleMoveAnims['powerdrum'] = {anim: BattleMoveAnims['bellydrum'].anim};
BattleMoveAnims['draculacradle'] = {anim: BattleMoveAnims['bravebird'].anim};
BattleMoveAnims['sakedrink'] = {anim: BattleMoveAnims['milkdrink'].anim};
BattleMoveAnims['butterfly'] = {anim: BattleMoveAnims['attackorder'].anim};
BattleMoveAnims['superego'] = {anim: BattleMoveAnims['attract'].anim};
BattleMoveAnims['zapflare'] = {anim: BattleMoveAnims['zapcannon'].anim};
BattleMoveAnims['savagesting'] = {anim: BattleMoveAnims['fellstinger'].anim};
BattleMoveAnims['divinepulse'] = {anim: BattleMoveAnims['dragonpulse'].anim};
BattleMoveAnims['holystrike'] = {anim: BattleMoveAnims['thunderpunch'].anim};
BattleMoveAnims['firebullets'] = {anim: BattleMoveAnims['flamethrower'].anim};
BattleMoveAnims['aquaveil'] = {anim: BattleMoveAnims['aquaring'].anim};
BattleMoveAnims['fujiyamavolcano'] = {anim: BattleMoveAnims['eruption'].anim};
BattleMoveAnims['corpserush'] = {anim: BattleMoveAnims['flareblitz'].anim};
BattleMoveAnims['poisonclaw'] = {anim: BattleMoveAnims['poisonjab'].anim};
BattleMoveAnims['ringoffire'] = {anim: BattleMoveAnims['explosion'].anim};
BattleMoveAnims['suwadeluge'] = {anim: BattleMoveAnims['hydropump'].anim};
BattleMoveAnims['apollo13'] = {anim: BattleMoveAnims['spiritshackle'].anim};
BattleMoveAnims['bugwhistle'] = {anim: BattleMoveAnims['grasswhistle'].anim};
BattleMoveAnims['hourairend'] = {anim: BattleMoveAnims['spacialrend'].anim};
BattleMoveAnims['watergeyser'] = {anim: BattleMoveAnims['waterspout'].anim};
BattleMoveAnims['rockgale'] = {anim: BattleMoveAnims['accelerock'].anim};
BattleMoveAnims['poisonwave'] = {anim: BattleMoveAnims['sludgewave'].anim};
...
BattleMoveAnims['airslash2'] = {anim: BattleMoveAnims['airslash'].anim};
BattleMoveAnims['amnesia2'] = {anim: BattleMoveAnims['amnesia'].anim};
BattleMoveAnims['ancientpower2'] = {anim: BattleMoveAnims['ancientpower'].anim};
BattleMoveAnims['aquajet2'] = {anim: BattleMoveAnims['aquajet'].anim};
BattleMoveAnims['aquashower'] = {anim: BattleMoveAnims['waterspout'].anim};
BattleMoveAnims['aromatherapy2'] = {anim: BattleMoveAnims['aromatherapy'].anim};
BattleMoveAnims['assist2'] = {anim: BattleMoveAnims['assist'].anim};
BattleMoveAnims['astonish2'] = {anim: BattleMoveAnims['astonish'].anim};
BattleMoveAnims['attract2'] = {anim: BattleMoveAnims['attract'].anim};
BattleMoveAnims['aurorabeam2'] = {anim: BattleMoveAnims['aurorabeam'].anim};
BattleMoveAnims['barrage2'] = {anim: BattleMoveAnims['barrage'].anim};
BattleMoveAnims['barrier2'] = {anim: BattleMoveAnims['barrier'].anim};
BattleMoveAnims['batonpass2'] = {anim: BattleMoveAnims['batonpass'].anim};
BattleMoveAnims['batterycharge'] = {anim: BattleMoveAnims['charge'].anim};
BattleMoveAnims['battlechant'] = {anim: BattleMoveAnims['meteormash'].anim};
BattleMoveAnims['beatup2'] = {anim: BattleMoveAnims['beatup'].anim};
BattleMoveAnims['bellydrum2'] = {anim: BattleMoveAnims['bellydrum'].anim};
BattleMoveAnims['bind2'] = {anim: BattleMoveAnims['bind'].anim};
BattleMoveAnims['bindingvoice'] = {anim: BattleMoveAnims['hypervoice'].anim};
BattleMoveAnims['bite2'] = {anim: BattleMoveAnims['bite'].anim};
BattleMoveAnims['blackripple'] = {anim: BattleMoveAnims['darkpulse'].anim};
BattleMoveAnims['bladeflash'] = {anim: BattleMoveAnims['extremespeed'].anim};
BattleMoveAnims['blastburn2'] = {anim: BattleMoveAnims['overheat'].anim};
BattleMoveAnims['blazekick2'] = {anim: BattleMoveAnims['blazekick'].anim};
BattleMoveAnims['blizzard2'] = {anim: BattleMoveAnims['blizzard'].anim};
BattleMoveAnims['block2'] = {anim: BattleMoveAnims['block'].anim};
BattleMoveAnims['bodyslam2'] = {anim: BattleMoveAnims['bodyslam'].anim};
BattleMoveAnims['boneclub2'] = {anim: BattleMoveAnims['boneclub'].anim};
BattleMoveAnims['bonerush2'] = {anim: BattleMoveAnims['bonerush'].anim};
BattleMoveAnims['bonemerang2'] = {anim: BattleMoveAnims['bonemerang'].anim};
BattleMoveAnims['bounce2'] = {anim: BattleMoveAnims['bounce'].anim};
BattleMoveAnims['bravebird2'] = {anim: BattleMoveAnims['bravebird'].anim};
BattleMoveAnims['braver'] = {anim: BattleMoveAnims['slash'].anim};
BattleMoveAnims['brickbreak2'] = {anim: BattleMoveAnims['brickbreak'].anim};
BattleMoveAnims['bubble2'] = {anim: BattleMoveAnims['bubble'].anim};
BattleMoveAnims['bubblebeam2'] = {anim: BattleMoveAnims['bubblebeam'].anim};
BattleMoveAnims['bulkup2'] = {anim: BattleMoveAnims['bulkup'].anim};
BattleMoveAnims['bulletseed2'] = {anim: BattleMoveAnims['bulletseed'].anim};
BattleMoveAnims['burnpowder'] = {anim: BattleMoveAnims['spore'].anim};
BattleMoveAnims['calmmind2'] = {anim: BattleMoveAnims['calmmind'].anim};
BattleMoveAnims['camouflage2'] = {anim: BattleMoveAnims['camouflage'].anim};
BattleMoveAnims['charminglook'] = {anim: BattleMoveAnims['attract'].anim};
BattleMoveAnims['coerce'] = {anim: BattleMoveAnims['spite'].anim};
BattleMoveAnims['cometpunch2'] = {anim: BattleMoveAnims['cometpunch'].anim};
BattleMoveAnims['confuseray2'] = {anim: BattleMoveAnims['confuseray'].anim};
BattleMoveAnims['constrict2'] = {anim: BattleMoveAnims['constrict'].anim};
BattleMoveAnims['conversionb'] = {anim: BattleMoveAnims['conversion'].anim};
BattleMoveAnims['conversion2b'] = {anim: BattleMoveAnims['conversionb'].anim};
BattleMoveAnims['cottonspore2'] = {anim: BattleMoveAnims['cottonspore'].anim};
BattleMoveAnims['counter2'] = {anim: BattleMoveAnims['counter'].anim};
BattleMoveAnims['crosschop2'] = {anim: BattleMoveAnims['crosschop'].anim};
BattleMoveAnims['crosspoison2'] = {anim: BattleMoveAnims['crosspoison'].anim};
BattleMoveAnims['crunch2'] = {anim: BattleMoveAnims['crunch'].anim};
BattleMoveAnims['crushclaw2'] = {anim: BattleMoveAnims['crushclaw'].anim};
BattleMoveAnims['curse2'] = {anim: BattleMoveAnims['curse'].anim};
BattleMoveAnims['cut2'] = {anim: BattleMoveAnims['cut'].anim};
BattleMoveAnims['darkpulse2'] = {anim: BattleMoveAnims['darkpulse'].anim};
BattleMoveAnims['decision'] = {anim: BattleMoveAnims['thundershock'].anim};
BattleMoveAnims['defensecurl2'] = {anim: BattleMoveAnims['defensecurl'].anim};
BattleMoveAnims['destinybond2'] = {anim: BattleMoveAnims['destinybond'].anim};
BattleMoveAnims['detect2'] = {anim: BattleMoveAnims['protect'].anim};
BattleMoveAnims['dig2'] = {anim: BattleMoveAnims['dig'].anim};
BattleMoveAnims['disable2'] = {anim: BattleMoveAnims['disable'].anim};
BattleMoveAnims['discharge2'] = {anim: BattleMoveAnims['discharge'].anim};
BattleMoveAnims['disperse'] = {anim: BattleMoveAnims['acidarmor'].anim};
BattleMoveAnims['disturbance'] = {anim: BattleMoveAnims['uproar'].anim};
BattleMoveAnims['dizzypunch2'] = {anim: BattleMoveAnims['dizzypunch'].anim};
BattleMoveAnims['doubleedge2'] = {anim: BattleMoveAnims['doubleedge'].anim};
BattleMoveAnims['doublekick2'] = {anim: BattleMoveAnims['doublekick'].anim};
BattleMoveAnims['meteorstorm'] = {anim: BattleMoveAnims['dracometeor'].anim};
BattleMoveAnims['drainpunch2'] = {anim: BattleMoveAnims['drainpunch'].anim};
BattleMoveAnims['drawnline'] = {anim: BattleMoveAnims['slash'].anim};
BattleMoveAnims['dreameater2'] = {anim: BattleMoveAnims['dreameater'].anim};
BattleMoveAnims['dynamicpunch2'] = {anim: BattleMoveAnims['dynamicpunch'].anim};
BattleMoveAnims['earthpower2'] = {anim: BattleMoveAnims['earthpower'].anim};
BattleMoveAnims['earthquake2'] = {anim: BattleMoveAnims['earthquake'].anim};
BattleMoveAnims['ember2'] = {anim: BattleMoveAnims['ember'].anim};
BattleMoveAnims['encore2'] = {anim: BattleMoveAnims['encore'].anim};
BattleMoveAnims['endeavor2'] = {anim: BattleMoveAnims['endeavor'].anim};
BattleMoveAnims['endure2'] = {anim: BattleMoveAnims['endure'].anim};
BattleMoveAnims['energyball2'] = {anim: BattleMoveAnims['focusblast'].anim};
BattleMoveAnims['energylight'] = {anim: BattleMoveAnims['energyball'].anim};
BattleMoveAnims['eruption2'] = {anim: BattleMoveAnims['eruption'].anim};
BattleMoveAnims['explosion2'] = {anim: BattleMoveAnims['explosion'].anim};
BattleMoveAnims['extrasensory2'] = {anim: BattleMoveAnims['extrasensory'].anim};
BattleMoveAnims['extremespeed2'] = {anim: BattleMoveAnims['extremespeed'].anim};
BattleMoveAnims['facade2'] = {anim: BattleMoveAnims['facade'].anim};
BattleMoveAnims['feintattack2'] = {anim: BattleMoveAnims['feintattack'].anim};
BattleMoveAnims['fakeout2'] = {anim: BattleMoveAnims['fakeout'].anim};
BattleMoveAnims['faketears2'] = {anim: BattleMoveAnims['faketears'].anim};
BattleMoveAnims['falseswipe2'] = {anim: BattleMoveAnims['falseswipe'].anim};
BattleMoveAnims['feint2'] = {anim: BattleMoveAnims['feint'].anim};
BattleMoveAnims['fireblast2'] = {anim: BattleMoveAnims['fireblast'].anim};
BattleMoveAnims['firepunch2'] = {anim: BattleMoveAnims['firepunch'].anim};
BattleMoveAnims['firespin2'] = {anim: BattleMoveAnims['firespin'].anim};
BattleMoveAnims['fissure2'] = {anim: BattleMoveAnims['fissure'].anim};
BattleMoveAnims['flail2'] = {anim: BattleMoveAnims['flail'].anim};
BattleMoveAnims['flamewheel2'] = {anim: BattleMoveAnims['flamewheel'].anim};
BattleMoveAnims['flamethrower2'] = {anim: BattleMoveAnims['flamethrower'].anim};
BattleMoveAnims['flareblitz2'] = {anim: BattleMoveAnims['flareblitz'].anim};
BattleMoveAnims['flash2'] = {anim: BattleMoveAnims['flash'].anim};
BattleMoveAnims['fly2'] = {anim: BattleMoveAnims['fly'].anim};
BattleMoveAnims['focusenergy2'] = {anim: BattleMoveAnims['focusenergy'].anim};
BattleMoveAnims['focuspunch2'] = {anim: BattleMoveAnims['focuspunch'].anim};
BattleMoveAnims['forcepalm2'] = {anim: BattleMoveAnims['forcepalm'].anim};
BattleMoveAnims['foresight2'] = {anim: BattleMoveAnims['foresight'].anim};
BattleMoveAnims['frenzyplant2'] = {anim: BattleMoveAnims['frenzyplant'].anim};
BattleMoveAnims['frustration2'] = {anim: BattleMoveAnims['frustration'].anim};
BattleMoveAnims['furycutter2'] = {anim: BattleMoveAnims['furycutter'].anim};
BattleMoveAnims['gale'] = {anim: BattleMoveAnims['gust'].anim};
BattleMoveAnims['gigadrain2'] = {anim: BattleMoveAnims['gigadrain'].anim};
BattleMoveAnims['gigaimpact2'] = {anim: BattleMoveAnims['gigaimpact'].anim};
BattleMoveAnims['growl2'] = {anim: BattleMoveAnims['growl'].anim};
BattleMoveAnims['growth2'] = {anim: BattleMoveAnims['growth'].anim};
BattleMoveAnims['guard'] = {anim: BattleMoveAnims['wideguard'].anim};
BattleMoveAnims['gunkshot2'] = {anim: BattleMoveAnims['gunkshot'].anim};
BattleMoveAnims['gust2'] = {anim: BattleMoveAnims['gust'].anim};
BattleMoveAnims['hail2'] = {anim: BattleMoveAnims['hail'].anim};
BattleMoveAnims['harden2'] = {anim: BattleMoveAnims['harden'].anim};
BattleMoveAnims['haze2'] = {anim: BattleMoveAnims['haze'].anim};
BattleMoveAnims['headrush'] = {anim: BattleMoveAnims['headbutt'].anim};
BattleMoveAnims['headsmash2'] = {anim: BattleMoveAnims['headsmash'].anim};
BattleMoveAnims['headbutt2'] = {anim: BattleMoveAnims['headbutt'].anim};
BattleMoveAnims['healbell2'] = {anim: BattleMoveAnims['healbell'].anim};
BattleMoveAnims['heartbreak'] = {anim: BattleMoveAnims['slash'].anim};
BattleMoveAnims['heartseye'] = {anim: BattleMoveAnims['miracleeye'].anim};
BattleMoveAnims['beastclaw'] = {anim: BattleMoveAnims['crushclaw'].anim};
BattleMoveAnims['heatwave2'] = {anim: BattleMoveAnims['heatwave'].anim};
BattleMoveAnims['helpinghand2'] = {anim: BattleMoveAnims['helpinghand'].anim};
BattleMoveAnims['highjumpkick2'] = {anim: BattleMoveAnims['highjumpkick'].anim};
BattleMoveAnims['howl2'] = {anim: BattleMoveAnims['howl'].anim};
BattleMoveAnims['hydrocannon2'] = {anim: BattleMoveAnims['hydrocannon'].anim};
BattleMoveAnims['hydropump2'] = {anim: BattleMoveAnims['hydropump'].anim};
BattleMoveAnims['hyperbeam2'] = {anim: BattleMoveAnims['hyperbeam'].anim};
BattleMoveAnims['hypervoice2'] = {anim: BattleMoveAnims['hypervoice'].anim};
BattleMoveAnims['hypnosis2'] = {anim: BattleMoveAnims['hypnosis'].anim};
BattleMoveAnims['iceball2'] = {anim: BattleMoveAnims['iceball'].anim};
BattleMoveAnims['icebeam2'] = {anim: BattleMoveAnims['icebeam'].anim};
BattleMoveAnims['icepunch2'] = {anim: BattleMoveAnims['icepunch'].anim};
BattleMoveAnims['iceshard2'] = {anim: BattleMoveAnims['iceshard'].anim};
BattleMoveAnims['icywind2'] = {anim: BattleMoveAnims['icywind'].anim};
BattleMoveAnims['imprison2'] = {anim: BattleMoveAnims['imprison'].anim};
BattleMoveAnims['ingrain2'] = {anim: BattleMoveAnims['ingrain'].anim};
BattleMoveAnims['irondefense2'] = {anim: BattleMoveAnims['irondefense'].anim};
BattleMoveAnims['jamming'] = {anim: BattleMoveAnims['block'].anim};
BattleMoveAnims['judgement'] = {anim: BattleMoveAnims['judgment'].anim};
BattleMoveAnims['jumpkick2'] = {anim: BattleMoveAnims['jumpkick'].anim};
BattleMoveAnims['karatechop2'] = {anim: BattleMoveAnims['karatechop'].anim};
BattleMoveAnims['killingbite'] = {anim: BattleMoveAnims['crunch'].anim};
BattleMoveAnims['knifethrow'] = {anim: BattleMoveAnims['rockthrow'].anim};
BattleMoveAnims['knockoff2'] = {anim: BattleMoveAnims['knockoff'].anim};
BattleMoveAnims['lavaplume2'] = {anim: BattleMoveAnims['lavaplume'].anim};
BattleMoveAnims['leafblade2'] = {anim: BattleMoveAnims['leafblade'].anim};
BattleMoveAnims['leechlife2'] = {anim: BattleMoveAnims['leechlife'].anim};
BattleMoveAnims['leechseed2'] = {anim: BattleMoveAnims['leechseed'].anim};
BattleMoveAnims['leer2'] = {anim: BattleMoveAnims['leer'].anim};
BattleMoveAnims['lick2'] = {anim: BattleMoveAnims['lick'].anim};
BattleMoveAnims['lightscreen2'] = {anim: BattleMoveAnims['lightscreen'].anim};
BattleMoveAnims['lockon2'] = {anim: BattleMoveAnims['lockon'].anim};
BattleMoveAnims['lovelykiss2'] = {anim: BattleMoveAnims['lovelykiss'].anim};
BattleMoveAnims['lowkick2'] = {anim: BattleMoveAnims['lowkick'].anim};
BattleMoveAnims['luckychant2'] = {anim: BattleMoveAnims['luckychant'].anim};
BattleMoveAnims['lunatic'] = {anim: BattleMoveAnims['hyperbeam'].anim};
BattleMoveAnims['lusterpurge2'] = {anim: BattleMoveAnims['lusterpurge'].anim};
BattleMoveAnims['machpunch2'] = {anim: BattleMoveAnims['machpunch'].anim};
BattleMoveAnims['magiccoat2'] = {anim: BattleMoveAnims['magiccoat'].anim};
BattleMoveAnims['magicknife'] = {anim: BattleMoveAnims['furyattack'].anim};
BattleMoveAnims['magicalleaf2'] = {anim: BattleMoveAnims['magicalleaf'].anim};
BattleMoveAnims['magnitude2'] = {anim: BattleMoveAnims['magnitude'].anim};
BattleMoveAnims['manaburst'] = {anim: BattleMoveAnims['psychic'].anim};
BattleMoveAnims['manacharge'] = {anim: BattleMoveAnims['calmmind'].anim};
BattleMoveAnims['manashield'] = {anim: BattleMoveAnims['calmmind'].anim};
BattleMoveAnims['megadrain2'] = {anim: BattleMoveAnims['megadrain'].anim};
BattleMoveAnims['memento2'] = {anim: BattleMoveAnims['memento'].anim};
BattleMoveAnims['metalclaw2'] = {anim: BattleMoveAnims['metalclaw'].anim};
BattleMoveAnims['meteormash2'] = {anim: BattleMoveAnims['meteormash'].anim};
BattleMoveAnims['metronome2'] = {anim: BattleMoveAnims['metronome'].anim};
BattleMoveAnims['milkdrink2'] = {anim: BattleMoveAnims['milkdrink'].anim};
BattleMoveAnims['mimic2'] = {anim: BattleMoveAnims['mimic'].anim};
BattleMoveAnims['mindbomb'] = {anim: BattleMoveAnims['shadowball'].anim};
BattleMoveAnims['minimize2'] = {anim: BattleMoveAnims['minimize'].anim};
BattleMoveAnims['mirrorcoat2'] = {anim: BattleMoveAnims['mirrorcoat'].anim};
BattleMoveAnims['mirrorshot2'] = {anim: BattleMoveAnims['mirrorshot'].anim};
BattleMoveAnims['mist2'] = {anim: BattleMoveAnims['mist'].anim};
BattleMoveAnims['mistball2'] = {anim: BattleMoveAnims['mistball'].anim};
BattleMoveAnims['mudshot2'] = {anim: BattleMoveAnims['mudshot'].anim};
BattleMoveAnims['mudslap2'] = {anim: BattleMoveAnims['mudslap'].anim};
BattleMoveAnims['muddywater2'] = {anim: BattleMoveAnims['muddywater'].anim};
BattleMoveAnims['mysticwater'] = {anim: BattleMoveAnims['aquaring'].anim};
BattleMoveAnims['nastyplot2'] = {anim: BattleMoveAnims['nastyplot'].anim};
BattleMoveAnims['naturepower2'] = {anim: BattleMoveAnims['naturepower'].anim};
BattleMoveAnims['naturesound'] = {anim: BattleMoveAnims['supersonic'].anim};
BattleMoveAnims['needlearm2'] = {anim: BattleMoveAnims['needlearm'].anim};
BattleMoveAnims['nightshade2'] = {anim: BattleMoveAnims['nightshade'].anim};
BattleMoveAnims['nightslash2'] = {anim: BattleMoveAnims['nightslash'].anim};
BattleMoveAnims['nightmare2'] = {anim: BattleMoveAnims['nightmare'].anim};
BattleMoveAnims['ominouswind2'] = {anim: BattleMoveAnims['ominouswind'].anim};
BattleMoveAnims['outrage2'] = {anim: BattleMoveAnims['outrage'].anim};
BattleMoveAnims['painsplit2'] = {anim: BattleMoveAnims['painsplit'].anim};
BattleMoveAnims['payday2'] = {anim: BattleMoveAnims['payday'].anim};
BattleMoveAnims['peck2'] = {anim: BattleMoveAnims['peck'].anim};
BattleMoveAnims['performance'] = {anim: BattleMoveAnims['uproar'].anim};
BattleMoveAnims['perishsong2'] = {anim: BattleMoveAnims['perishsong'].anim};
BattleMoveAnims['pinmissile2'] = {anim: BattleMoveAnims['pinmissile'].anim};
BattleMoveAnims['poisonbomb'] = {anim: BattleMoveAnims['sludgebomb'].anim};
BattleMoveAnims['poisonjab2'] = {anim: BattleMoveAnims['poisonjab'].anim};
BattleMoveAnims['poisonsting2'] = {anim: BattleMoveAnims['poisonsting'].anim};
BattleMoveAnims['poisontears'] = {anim: BattleMoveAnims['acid'].anim};
BattleMoveAnims['poisonpowder2'] = {anim: BattleMoveAnims['poisonpowder'].anim};
BattleMoveAnims['pound2'] = {anim: BattleMoveAnims['pound'].anim};
BattleMoveAnims['powdersnow2'] = {anim: BattleMoveAnims['powdersnow'].anim};
BattleMoveAnims['powerwhip2'] = {anim: BattleMoveAnims['powerwhip'].anim};
BattleMoveAnims['prank'] = {anim: BattleMoveAnims['fakeout'].anim};
BattleMoveAnims['protect2'] = {anim: BattleMoveAnims['protect'].anim};
BattleMoveAnims['psybeam2'] = {anim: BattleMoveAnims['psybeam'].anim};
BattleMoveAnims['psychup2'] = {anim: BattleMoveAnims['psychup'].anim};
BattleMoveAnims['psychoboost2'] = {anim: BattleMoveAnims['psychoboost'].anim};
BattleMoveAnims['psychocut2'] = {anim: BattleMoveAnims['psychocut'].anim};
BattleMoveAnims['psyshot'] = {anim: BattleMoveAnims['confusion'].anim};
BattleMoveAnims['psywave2'] = {anim: BattleMoveAnims['psywave'].anim};
BattleMoveAnims['pursuit2'] = {anim: BattleMoveAnims['pursuit'].anim};
BattleMoveAnims['quickattack2'] = {anim: BattleMoveAnims['quickattack'].anim};
BattleMoveAnims['rage2'] = {anim: BattleMoveAnims['rage'].anim};
BattleMoveAnims['raindance2'] = {anim: BattleMoveAnims['raindance'].anim};
BattleMoveAnims['rapidspin2'] = {anim: BattleMoveAnims['rapidspin'].anim};
BattleMoveAnims['razorleaf2'] = {anim: BattleMoveAnims['razorleaf'].anim};
BattleMoveAnims['razorwind2'] = {anim: BattleMoveAnims['aircutter'].anim};
BattleMoveAnims['recollection'] = {anim: BattleMoveAnims['transform'].anim};
BattleMoveAnims['recover2'] = {anim: BattleMoveAnims['recover'].anim};
BattleMoveAnims['recycle2'] = {anim: BattleMoveAnims['recycle'].anim};
BattleMoveAnims['reflect2'] = {anim: BattleMoveAnims['reflect'].anim};
BattleMoveAnims['refresh2'] = {anim: BattleMoveAnims['refresh'].anim};
BattleMoveAnims['rest2'] = {anim: BattleMoveAnims['rest'].anim};
BattleMoveAnims['return2'] = {anim: BattleMoveAnims['return'].anim};
BattleMoveAnims['revenge2'] = {anim: BattleMoveAnims['revenge'].anim};
BattleMoveAnims['reversal2'] = {anim: BattleMoveAnims['reversal'].anim};
BattleMoveAnims['roar2'] = {anim: BattleMoveAnims['roar'].anim};
BattleMoveAnims['rockblast2'] = {anim: BattleMoveAnims['rockblast'].anim};
BattleMoveAnims['rockbullet'] = {anim: BattleMoveAnims['accelerock'].anim};
BattleMoveAnims['rockslide2'] = {anim: BattleMoveAnims['rockslide'].anim};
BattleMoveAnims['rocksmash2'] = {anim: BattleMoveAnims['rocksmash'].anim};
BattleMoveAnims['rocktomb2'] = {anim: BattleMoveAnims['rocktomb'].anim};
BattleMoveAnims['rockwrecker2'] = {anim: BattleMoveAnims['rockwrecker'].anim};
BattleMoveAnims['rollingkick2'] = {anim: BattleMoveAnims['rollingkick'].anim};
BattleMoveAnims['roost2'] = {anim: BattleMoveAnims['roost'].anim};
BattleMoveAnims['sacredfire2'] = {anim: BattleMoveAnims['sacredfire'].anim};
BattleMoveAnims['safeguard2'] = {anim: BattleMoveAnims['safeguard'].anim};
BattleMoveAnims['lunadial'] = {anim: BattleMoveAnims['sheercold'].anim};
BattleMoveAnims['sandattack2'] = {anim: BattleMoveAnims['sandattack'].anim};
BattleMoveAnims['sandtomb2'] = {anim: BattleMoveAnims['sandtomb'].anim};
BattleMoveAnims['sandstorm2'] = {anim: BattleMoveAnims['sandstorm'].anim};
BattleMoveAnims['scaryface2'] = {anim: BattleMoveAnims['scaryface'].anim};
BattleMoveAnims['scratch2'] = {anim: BattleMoveAnims['scratch'].anim};
BattleMoveAnims['screech2'] = {anim: BattleMoveAnims['screech'].anim};
BattleMoveAnims['sculpture'] = {anim: BattleMoveAnims['slash'].anim};
BattleMoveAnims['sealingneedle'] = {anim: BattleMoveAnims['pinmissile'].anim};
BattleMoveAnims['secretpower2'] = {anim: BattleMoveAnims['secretpower'].anim};
BattleMoveAnims['seismictoss2'] = {anim: BattleMoveAnims['seismictoss'].anim};
BattleMoveAnims['selfdestruct2'] = {anim: BattleMoveAnims['selfdestruct'].anim};
BattleMoveAnims['shadowball2'] = {anim: BattleMoveAnims['shadowball'].anim};
BattleMoveAnims['shadowdance'] = {anim: BattleMoveAnims['thrash'].anim};
BattleMoveAnims['shadowdive'] = {anim: BattleMoveAnims['dive'].anim};
BattleMoveAnims['shadowhit'] = {anim: BattleMoveAnims['shadowclaw'].anim};
BattleMoveAnims['shadowpunch2'] = {anim: BattleMoveAnims['shadowpunch'].anim};
BattleMoveAnims['sharpen2'] = {anim: BattleMoveAnims['sharpen'].anim};
BattleMoveAnims['sheercold2'] = {anim: BattleMoveAnims['sheercold'].anim};
BattleMoveAnims['shockwave2'] = {anim: BattleMoveAnims['shockwave'].anim};
BattleMoveAnims['signalbeam2'] = {anim: BattleMoveAnims['signalbeam'].anim};
BattleMoveAnims['silverwind2'] = {anim: BattleMoveAnims['silverwind'].anim};
BattleMoveAnims['sing2'] = {anim: BattleMoveAnims['sing'].anim};
BattleMoveAnims['sketch2'] = {anim: BattleMoveAnims['sketch'].anim};
BattleMoveAnims['skillswap2'] = {anim: BattleMoveAnims['skillswap'].anim};
BattleMoveAnims['skullbash2'] = {anim: BattleMoveAnims['skullbash'].anim};
BattleMoveAnims['skyattack2'] = {anim: BattleMoveAnims['skyattack'].anim};
BattleMoveAnims['slackoff2'] = {anim: BattleMoveAnims['slackoff'].anim};
BattleMoveAnims['slash2'] = {anim: BattleMoveAnims['slash'].anim};
BattleMoveAnims['sleeppowder2'] = {anim: BattleMoveAnims['sleeppowder'].anim};
BattleMoveAnims['sleeptalk2'] = {anim: BattleMoveAnims['sleeptalk'].anim};
BattleMoveAnims['smellingsalts2'] = {anim: BattleMoveAnims['smellingsalts'].anim};
BattleMoveAnims['smile'] = {anim: BattleMoveAnims['charm'].anim};
BattleMoveAnims['smokescreen2'] = {anim: BattleMoveAnims['smokescreen'].anim};
BattleMoveAnims['snatch2'] = {anim: BattleMoveAnims['snatch'].anim};
BattleMoveAnims['snore2'] = {anim: BattleMoveAnims['snore'].anim};
BattleMoveAnims['soar'] = {anim: BattleMoveAnims['skyuppercut'].anim};
BattleMoveAnims['softboiled2'] = {anim: BattleMoveAnims['softboiled'].anim};
BattleMoveAnims['solarbeam2'] = {anim: BattleMoveAnims['solarbeam'].anim};
BattleMoveAnims['sonicboom2'] = {anim: BattleMoveAnims['sonicboom'].anim};
BattleMoveAnims['spiderweb2'] = {anim: BattleMoveAnims['spiderweb'].anim};
BattleMoveAnims['spikes2'] = {anim: BattleMoveAnims['spikes'].anim};
...
BattleMoveAnims['stunspore2'] = {anim: BattleMoveAnims['stunspore'].anim};
BattleMoveAnims['submission2'] = {anim: BattleMoveAnims['submission'].anim};
BattleMoveAnims['substitute2'] = {anim: BattleMoveAnims['substitute'].anim};
BattleMoveAnims['sunnyday2'] = {anim: BattleMoveAnims['sunnyday'].anim};
BattleMoveAnims['superpower2'] = {anim: BattleMoveAnims['superpower'].anim};
BattleMoveAnims['surf2'] = {anim: BattleMoveAnims['surf'].anim};
BattleMoveAnims['swagger2'] = {anim: BattleMoveAnims['swagger'].anim};
BattleMoveAnims['sweetkiss2'] = {anim: BattleMoveAnims['sweetkiss'].anim};
BattleMoveAnims['swift2'] = {anim: BattleMoveAnims['swift'].anim};
BattleMoveAnims['swordsdance2'] = {anim: BattleMoveAnims['swordsdance'].anim};
BattleMoveAnims['synthesis2'] = {anim: BattleMoveAnims['synthesis'].anim};
BattleMoveAnims['tackle2'] = {anim: BattleMoveAnims['tackle'].anim};
BattleMoveAnims['tailwhip2'] = {anim: BattleMoveAnims['tailwhip'].anim};
BattleMoveAnims['tailwind2'] = {anim: BattleMoveAnims['dragondance'].anim};
BattleMoveAnims['taunt2'] = {anim: BattleMoveAnims['taunt'].anim};
BattleMoveAnims['teeterdance2'] = {anim: BattleMoveAnims['teeterdance'].anim};
BattleMoveAnims['teleport2'] = {anim: BattleMoveAnims['teleport'].anim};
BattleMoveAnims['thief2'] = {anim: BattleMoveAnims['thief'].anim};
BattleMoveAnims['thrash2'] = {anim: BattleMoveAnims['thrash'].anim};
BattleMoveAnims['thunder2'] = {anim: BattleMoveAnims['thunder'].anim};
BattleMoveAnims['thunderwave2'] = {anim: BattleMoveAnims['thunderwave'].anim};
BattleMoveAnims['thunderbolt2'] = {anim: BattleMoveAnims['thunderbolt'].anim};
BattleMoveAnims['thunderpunch2'] = {anim: BattleMoveAnims['thunderpunch'].anim};
BattleMoveAnims['thundershock2'] = {anim: BattleMoveAnims['thundershock'].anim};
BattleMoveAnims['tickle2'] = {anim: BattleMoveAnims['tickle'].anim};
BattleMoveAnims['torment2'] = {anim: BattleMoveAnims['torment'].anim};
BattleMoveAnims['toxic2'] = {anim: BattleMoveAnims['toxic'].anim};
BattleMoveAnims['toxicgas'] = {anim: BattleMoveAnims['poisongas'].anim};
BattleMoveAnims['transform2'] = {anim: BattleMoveAnims['transform'].anim};
BattleMoveAnims['tremors'] = {anim: BattleMoveAnims['magnitude'].anim};
BattleMoveAnims['triattack2'] = {anim: BattleMoveAnims['triattack'].anim};
BattleMoveAnims['trick2'] = {anim: BattleMoveAnims['trick'].anim};
BattleMoveAnims['triplekick2'] = {anim: BattleMoveAnims['triplekick'].anim};
BattleMoveAnims['twister2'] = {anim: BattleMoveAnims['twister'].anim};
BattleMoveAnims['vinewhip2'] = {anim: BattleMoveAnims['vinewhip'].anim};
BattleMoveAnims['vitalthrow2'] = {anim: BattleMoveAnims['vitalthrow'].anim};
BattleMoveAnims['volttackle2'] = {anim: BattleMoveAnims['volttackle'].anim};
BattleMoveAnims['wanting'] = {anim: BattleMoveAnims['covet'].anim};
BattleMoveAnims['watergun2'] = {anim: BattleMoveAnims['watergun'].anim};
BattleMoveAnims['waterpulse2'] = {anim: BattleMoveAnims['waterpulse'].anim};
BattleMoveAnims['waterfall2'] = {anim: BattleMoveAnims['waterfall'].anim};
BattleMoveAnims['weatherball2'] = {anim: BattleMoveAnims['weatherball'].anim};
BattleMoveAnims['whirlpool2'] = {anim: BattleMoveAnims['whirlpool'].anim};
BattleMoveAnims['whirlwind2'] = {anim: BattleMoveAnims['whirlwind'].anim};
BattleMoveAnims['willowisp2'] = {anim: BattleMoveAnims['willowisp'].anim};
BattleMoveAnims['wingattack2'] = {anim: BattleMoveAnims['wingattack'].anim};
BattleMoveAnims['wireweb'] = {anim: BattleMoveAnims['stringshot'].anim};
BattleMoveAnims['wish2'] = {anim: BattleMoveAnims['wish'].anim};
BattleMoveAnims['withdraw2'] = {anim: BattleMoveAnims['withdraw'].anim};
BattleMoveAnims['wrap2'] = {anim: BattleMoveAnims['wrap'].anim};
...
BattleMoveAnims['clawsofguthix'] = {anim: BattleMoveAnims['stoneedge'].anim};
...
BattleMoveAnims['ragingdemon'] = {
	anim(scene, [attacker, defender]) {
		scene.backgroundEffect('#000000', 1400, 1.0);

...
class BattlesPanel extends PSRoomPanel<BattlesRoom> {
	...
	render() {
		...
		return <PSPanelWrapper room={room} scrollable><div class="pad">
			...
			<div class="roomlist">
				<p>
					<button class="button" name="refresh" onClick={this.refresh}><i class="fa fa-refresh"></i> Refresh</button> <span style={Dex.getPokemonIcon('marisa') + ';display:inline-block;vertical-align:middle'} class="picon" title="Marisa wants strong opponents!"></span>
				</p>
